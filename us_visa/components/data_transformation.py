...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->ColumnTransformer:
        """
        Method Name : get_data_transform_object
        Description : This method creates and returns a data transform object for the data 

        Output : data transform object is created and returned
        On Failure : Write an exception log and then raise an exception
        """

        logging.info(
            "Entered get_data_transform_object method of DataTransform class"
        )
        ...
        try:
            ...
            logging.info(
                'Exited get_data_transform_object method of DataTransformer class'
            )
            return preprocessor
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                logging.info("Dropping columns from training dataset")
                ...
                logging.info("Dropping columns from test dataset")
                ...
                logging.info(
                    "Used the preprocessor object to fit and transform the train features"
                )
